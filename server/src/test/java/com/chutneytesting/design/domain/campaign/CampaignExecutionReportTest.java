...
public class CampaignExecutionReportTest {
    ...
    public void should_take_the_earliest_scenario_start_date_as_start_date() {
        ...
        // When
        CampaignExecutionReport campaignReport = new CampaignExecutionReport(1L, 1L,Lists.list(execution_noTime, scenarioReport_5mn, scenarioReport_2mn), "...", false, "");
    ...
    public void should_set_start_date_as_min_possible_date_when_no_scenario_times_are_available() {
        ...
        // When
        CampaignExecutionReport campaignReport = new CampaignExecutionReport(1L, 1L,Lists.list(scenarioReport1, scenarioReport2), "...", false, "");
    ...
    public void should_set_status_when_instantiate_with_empty_scenario_reports() {
        // When
        CampaignExecutionReport campaignReport = new CampaignExecutionReport(1L, 1L, Collections.emptyList(), "...", false, "");
        // Then
    ...
    public void should_set_to_worst_status_when_instantiate_with_scenario_reports() {
        ...
        // When
        CampaignExecutionReport campaignReport = new CampaignExecutionReport(1L, 1L, Lists.list(execution_noStatus, scenarioReport_SUCCESS, scenarioReport_FAILURE), "...", false, "");
        // Then
    ...
    public void should_start_scenario_execution() {
        ...
        // When
        campaignReport.initExecution(Collections.singletonList(testCase), "env");
        campaignReport.startScenarioExecution(testCase, "env");
    ...
    private void addScenarioExecutions(CampaignExecutionReport campaignReport, String scenarioId, String scenarioTitle, ServerReportStatus scenarioExecutionStatus) {
        ...
        campaignReport.initExecution(Collections.singletonList(testCase), "");
