...
public class JsonHomePageRepositoryTest {
    ...
    public void should_backup_home_page_file_as_zip_file() throws IOException {
        ...
        Path tempDirRoot = Paths.get(temporaryFolderPath()).resolve(JsonHomePageRepository.ROOT_DIRECTORY_NAME);
        Files.createDirectories(tempDirRoot);
        Path homePagePath = tempDirRoot.resolve(JsonHomePageRepository.HOME_PAGE_NAME);
        ...
        assertThat(entriesNames).containsExactly(JsonHomePageRepository.HOME_PAGE_NAME);
    }
