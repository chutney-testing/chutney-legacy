...
public class SecuredControllerSpringBootIntegrationTest {
    ...
    private static Object[] securedEndPointList() {
        return new Object[][]{
            ...
            {POST, "/api/ui/component/execution/v1/componentId/env", "COMPONENT_WRITE", null},
            {POST, "/api/idea/scenario/execution/env", "SCENARIO_EXECUTE", "{\"content\":\"{}\",\"params\":{}} "},
            ...
            {GET, "/api/task/v1", "COMPONENT_READ", null},
            {GET, "/api/task/v1/taskId", "COMPONENT_READ", null},
