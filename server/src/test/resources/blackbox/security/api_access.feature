    ...
    Scenario Outline: A user must be authenticated and has <authority> authority to access <uri> with verb <http-verb>
        ...
        Then The HTTP response status is 401
            Do compare
                ...
                With expected 401
                With mode equals
        When A known user access the api without the correct authority
        ...
        Then The HTTP response status is 403
            Do compare
                ...
                With expected 403
                With mode equals
        And Remove the authority to the user
            ...
            Do compare Assert HTTP status is 200
                ...
                With expected 200
                With mode equals
        When A known user access the api with the correct <authority> authority (softly:)
            ...
            Do http-<http-verb> Access the api
                ...
                With timeout 5 s
                With body <body>
        Then The HTTP response status is <status> (softly:)
            Do compare
                With actual ${#status}
                With expected <status>
                With mode equals
        And Clean roles and authorizations (softly:)
            Do http-post Post roles and authorizations to Chutney instance
                On CHUTNEY_LOCAL
                With uri /api/v1/authorizations
                With headers
        ...
        Examples:
            ...
            | get       | /api/ui/scenario/executionasync/v1/scenarioId/execution/666        | SCENARIO_EXECUTE   |                                                                 | 404    |
