package com.chutneytesting.scenario.infra.compose.wrapper;

import static com.chutneytesting.scenario.infra.compose.orient.OrientComponentDB.TESTCASE_CLASS_PROPERTY_AUTHOR;
import static com.chutneytesting.scenario.infra.compose.orient.OrientComponentDB.TESTCASE_CLASS_PROPERTY_CREATIONDATE;
import static com.chutneytesting.scenario.infra.compose.orient.OrientComponentDB.TESTCASE_CLASS_PROPERTY_DATASET_ID;
import static com.chutneytesting.scenario.infra.compose.orient.OrientComponentDB.TESTCASE_CLASS_PROPERTY_DESCRIPTION;
import static com.chutneytesting.scenario.infra.compose.orient.OrientComponentDB.TESTCASE_CLASS_PROPERTY_PARAMETERS;
import static com.chutneytesting.scenario.infra.compose.orient.OrientComponentDB.TESTCASE_CLASS_PROPERTY_TAGS;
import static com.chutneytesting.scenario.infra.compose.orient.OrientComponentDB.TESTCASE_CLASS_PROPERTY_TITLE;
import static com.chutneytesting.scenario.infra.compose.orient.OrientComponentDB.TESTCASE_CLASS_PROPERTY_UPDATEDATE;
import static com.chutneytesting.scenario.infra.compose.orient.OrientUtils.setOnlyOnceProperty;
import static com.chutneytesting.scenario.infra.compose.orient.OrientUtils.setOrRemoveProperty;
...
/**
 * TestCase OrientDB model merges {@link com.chutneytesting.scenario.domain.compose.ComposableTestCase} metadata and
 * {@link com.chutneytesting.scenario.domain.compose.ComposableScenario} steps and parameters.
 *
 * For this reason,
 * the vertex wrapped inside is sometime treated as a {@link com.chutneytesting.scenario.infra.compose.wrapper.StepVertex} "root step",
