...
public class ComposedTestCaseDatatableIterationsPreProcessor implements TestCasePreProcessor<ExecutableComposedTestCase> {
    ...
    private List<ExecutableComposedStep> buildStepIterations(ExecutableComposedStep composedStep,
        ...
        updateIndexedOutputsUsingExecutionParameterValues(iterationOutputs, composedStep.executionParameters);
        return iterations;
    }
    ...
    private void updateIndexedOutputsUsingExecutionParameterValues(Map<String, Integer> iterationOutputs, Map<String, String> executionParameters) {
        executionParameters.entrySet().stream()
            ...
            .forEach(entry -> {
                ...
                iterationOutputs.put(executionParameters.get(entry.getKey()), iterationsCount);
            });
    }
