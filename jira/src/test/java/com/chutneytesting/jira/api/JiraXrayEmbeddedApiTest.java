...
class JiraXrayEmbeddedApiTest {
    ...
    void updateTestExecution() {
        ...
        JiraTargetConfiguration expected = new JiraTargetConfiguration("an url", "a username", "a password");
        assertThat(expected).usingRecursiveComparison().isEqualTo(configurationValue);
