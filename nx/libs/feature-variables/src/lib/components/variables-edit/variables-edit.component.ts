...
@Component({
  selector: 'chutney-variables-edit',
  templateUrl: './variables-edit.component.html',
  styleUrls: ['./variables-edit.component.scss']
})
export class VariablesEditComponent implements OnInit, OnDestroy {
  ...
  updateMode(): boolean {
    return this.addMode || this.renameMode;
  }

  private validateGroupNameInput(): boolean {
