...
public class ResourceResolver implements LSResourceResolver {
    ...
    public LSInput resolveResource(String type, String namespaceURI, String publicId, String systemId, String baseURI)  {
        ...
        try {
            ...
            ResourceLoader resourceLoader = new DefaultResourceLoader(XsdValidationTask.class.getClassLoader());
    ...
    private Path getParentResourcePath(String baseURI) {
        return Path.of(StringUtils.substringAfter(baseURI,"/chutney/task-impl/")).getParent();
    }
}
