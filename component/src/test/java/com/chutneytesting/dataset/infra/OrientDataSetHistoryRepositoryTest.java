...
import com.chutneytesting.dataset.infra.OrientDataSetHistoryRepository;
...
public class OrientDataSetHistoryRepositoryTest {
    ...
    public void should_find_dataset_version() {
        ...
        for (int i = 0; i < dataSets.size(); i++) {
            Assertions.assertThat(sut.version(originalDataSet.id, i + 1)).isEqualTo(dataSets.get(i));
        }
    }
    ...
    public void should_find_all_version() {
        ...
        Assertions.assertThat(sut.allVersions(originalDataSet.id)).containsExactlyInAnyOrderEntriesOf(Map.of(
    ...
    public void should_remove_dataset_history() {
        addVersionsAndAssert();
        Assertions.assertThat(sut.lastVersion(originalDataSet.id)).isEqualTo(6);
    ...
    private List<DataSet> addVersionsAndAssert() {
        ...
        DataSet datasetWithNewConstants = DataSet.builder()
            ...
            .withCreationDate(null)
            .withConstants(Map.of("uk1", "uv11", "uk22", "uv2"))
            .build();
        ...
        DataSet datasetWithNewDatatable = DataSet.builder()
            ...
            .withDatatable(Lists.list(
                Map.of("mk1", "mv11", "mk2", "mv21", "mk3", "mv31"),
                Map.of("mk1", "new12", "mk2", "mv22", "mk3", "mv32"),
                Map.of("mk1", "mv13", "mk2", "new23", "mk3", "mv33")
            ))
            .build();
