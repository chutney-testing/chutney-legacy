...
import { Component, EventEmitter, Input, OnDestroy, Output, ViewChild, SimpleChanges, OnChanges } from '@angular/core';
import { Location } from '@angular/common';
import { Subscription } from 'rxjs';
import { debounceTime, delay, map, tap, throttleTime } from 'rxjs/operators';
import { NgbDate, NgbDateStruct, NgbOffcanvas } from '@ng-bootstrap/ng-bootstrap';
...
export class DatabaseAdminExecutionReportListComponent implements OnChanges, OnDestroy {
