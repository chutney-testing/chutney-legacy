...
public class GlacioAdapterConfiguration {
    ...
    private StepFactory createExecutableStepFactory() throws IOException {
        ...
        DefaultGlacioParser defaultGlacioParser = new DefaultGlacioParser(executionConfiguration.taskTemplateRegistry(), environmentConfiguration.getEmbeddedEnvironmentApi());
